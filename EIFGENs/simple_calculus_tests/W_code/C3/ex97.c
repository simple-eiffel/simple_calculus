...
extern EIF_TYPED_VALUE F97_1504(EIF_REFERENCE);
...
RTOID (F97_1504)
EIF_TYPED_VALUE F97_1504 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 96, Current, 0, 0, 1547);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(96, Current, 1547);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
