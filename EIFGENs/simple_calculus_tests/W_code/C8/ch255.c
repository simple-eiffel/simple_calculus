...
EIF_TYPED_VALUE F255_5943 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 254, Current, 0, 0, 13095);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(254, Current, 13095);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F255_5944 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 254, Current, 0, 0, 13096);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(254, Current, 13096);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F255_5945 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 254, Current, 0, 0, 13097);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(254, Current, 13097);
	RTIV(Current, RTAL);
	RTHOOK(1);
