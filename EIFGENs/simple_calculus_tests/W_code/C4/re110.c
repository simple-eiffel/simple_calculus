...
EIF_TYPED_VALUE F110_1572 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 109, Current, 0, 0, 1615);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(109, Current, 1615);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1572, 140))(Current)).it_i4);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 109, Current, 0, 0, 1616);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(109, Current, 1616);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
