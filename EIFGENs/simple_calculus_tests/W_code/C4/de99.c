...
EIF_TYPED_VALUE F99_1537 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 98, Current, 0, 0, 1580);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1582, 140))(Current)).it_i4);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 98, Current, 0, 0, 1581);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
