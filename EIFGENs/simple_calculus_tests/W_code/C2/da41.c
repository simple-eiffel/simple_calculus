...
extern EIF_TYPED_VALUE F41_845(EIF_REFERENCE);
extern EIF_TYPED_VALUE F41_846(EIF_REFERENCE);
...
EIF_TYPED_VALUE F41_845 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F41_845,926,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F41_846)
EIF_TYPED_VALUE F41_846 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 40, Current, 0, 0, 926);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {341,0xFF01,270,0xFFFF};
		EIF_TYPE typres0;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 40, Current, 0, 0, 927);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
{
	GTCX
	RTOTC (F41_850,931,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F41_851,932,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOTC (F41_852,933,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
