...
extern EIF_TYPED_VALUE F977_1053(EIF_REFERENCE);
extern void F977_1054(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F977_1055(EIF_REFERENCE);
...
/* {LINKABLE}.right */
EIF_TYPED_VALUE F977_1053 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {LINKABLE}.put_right */
void F977_1054 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 976, Current, 0, 1, 1103);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(976, Current, 1103);
	RTCC(arg1, 976, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1014, 0xF80003D0, 0); /* right */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
void F977_1055 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 976, Current, 0, 0, 1104);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(976, Current, 1104);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1014, 0xF80003D0, 0); /* right */
