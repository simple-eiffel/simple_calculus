...
static const EIF_TYPE_INDEX egt_1_207 [] = {0xFF01,292,206,0xFFFF};
...
static const struct desc_info desc_207[] = {
	...
	{EIF_GENERIC(egt_13_207), 0x00, 0xFFFFFFFF},
};
void Init207(void)
{
	IDSC(desc_207, 0, 206);
